...
export const PLAYER_CAPSULE_HALF_HEIGHT = 1.3;
export const PLAYER_STANDING_HEIGHT = (PLAYER_CAPSULE_RADIUS + PLAYER_CAPSULE_HALF_HEIGHT) * 2;
export const PLAYER_EYE_HEIGHT = 1.35;
