...
/**
 * Portal visibility for anchorage interiors.
 *
...
export function cellContainingPoint(graph: AnchorageGraph, point: Vec3Tuple): CellId | null {
...
export function pointInCell(cell: AnchorageCell, point: Vec3Tuple): boolean {
  return (
 ...
 */
export function portalCorners(portal: AnchoragePortal): Vec3Tuple[] {
 ...
 */
export function projectPortalToNdcRect(portal: AnchoragePortal, viewProjection: Mat4): NdcRect | null {
...
export function buildAdjacency(graph: AnchorageGraph): Map<CellId, AnchoragePortal[]> {
  const adjacency = new Map<CellId, AnchoragePortal[]>();
...
function pushPortal(adjacency: Map<CellId, AnchoragePortal[]>, cell: CellId, portal: AnchoragePortal): void {
