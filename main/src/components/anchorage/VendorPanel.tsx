...
import { askVendor, aiMode } from '../../game/anchorage/anchorageAiClient.ts';
import { commodity, type CommodityId } from '../../game/anchorage/anchorageCommodities.ts';
import {
  greetingTurn,
  MAX_PLAYER_INPUT,
  sanitisePlayerInput,
  type ConversationTurn
} from '../../game/anchorage/anchorageConversation.ts';
import {
  commitBuy,
  commitSell,
  freeVolume,
...
import type { Vendor } from '../../game/anchorage/anchorageVendors.ts';
...
export function VendorPanel({ vendor, trader, onTrade, onClose }: VendorPanelProps) {
  ...
  return (
    <div style={backdrop} onClick={onClose} data-testid="anchorage-vendor-panel">
