...
const SCORE_BARE_PULSE_VOICE_CAP = 1;
const SCORE_COLOR_PULSE_VOICE_CAP = 2;
const SCORE_NO_VOICE_CAP = 0;
const SCORE_BARE_TRIANGLE_VOICE_CAP = 0;
const SCORE_COLOR_TRIANGLE_VOICE_CAP = 1;
...
const HIT_BARE_UPPER_VOICE_CAP = 0;
const HIT_COLOR_UPPER_VOICE_CAP = 0;
const HIT_MATERIAL_UPPER_VOICE_CAP = 4;
const HIT_ALIVE_UPPER_VOICE_CAP = 4;
const HIT_BARE_MAX_PITCHED_VOICES = 0;
const HIT_COLOR_MAX_PITCHED_VOICES = 0;
